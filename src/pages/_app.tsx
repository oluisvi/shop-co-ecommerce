...
export default function App({ Component, pageProps }: AppProps) {
  return <AuthProvider><CommerceProvider><div className={`${satoshi.variable} ${integral.variable} ${bodoni.variable}`}><Component {...pageProps} /></div></CommerceProvider></AuthProvider>;
}
