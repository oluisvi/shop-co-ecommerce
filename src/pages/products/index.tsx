  ...
  return (
    <>
      <SiteHead
        ...
        description="Preview the One Life Graphic T-shirt, its available style options, and customer reviews."
        path="/products"
      />
      <SiteLayout>
        <section className="product-page">
          <div className="container">
            <nav className="breadcrumb" aria-label="Breadcrumb">
              ...
              <span aria-hidden="true">/</span>
              <span aria-current="page">One Life Graphic T-shirt</span>
            </nav>
            ...
            <div className="product-detail">
                ...
                <div className="gallery-thumbs" aria-label="Product images">
                  {gallery.map((item, index) => (
                    <button
                      key={item.src}
                      type="button"
                      aria-label={`Show ${item.alt.toLowerCase()}`}
              ...
              <article className="product-information">
                <p className="issue-label">Product file / 001</p>
                ...
                <p className="product-description">
                  A graphic T-shirt made for everyday expression. Its soft, breathable feel balances a bold
                  print with an easy silhouette.
                </p>

                <fieldset className="option-group">
                  <legend>
                    Select color <span>{color}</span>
                  </legend>
                ...
                <fieldset className="option-group">
                  <legend>
                    Choose size <span>{size}</span>
                  </legend>
                  <div className="size-options">
                    {["Small", "Medium", "Large", "X-Large"].map((option) => (
                      <button
                        key={option}
                        type="button"
                ...
                <div className="purchase-row">
                  <div className="quantity" aria-label="Quantity">
                    <button
                      ...
                      disabled={quantity === 1}
                      onClick={() => setQuantity((value) => changeQuantity(value, -1))}
                    >
                      −
                    </button>
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() => setNotice("Cart functionality will be available in the next version.")}
                  >
                    Add to cart
                  </button>
                </div>

                <p className="cart-notice" aria-live="polite">
                  {notice}
                </p>
        ...
        <section className="journal-section product-reviews">
          <div className="container">
            <SectionHeader index="01" label="Wearer notes" title="Ratings & reviews" />
            <div className="reviews-grid reviews-grid--product">
        ...
        <section className="journal-section recommendations">
          <div className="container">
            <SectionHeader index="02" label="Continue the edit" title="You might also like" />
