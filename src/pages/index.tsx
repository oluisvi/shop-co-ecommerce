...
export default function Home() {
  return (
    <>
      <SiteHead
        title="SHOP.CO | Modern Fashion for Every Style"
        description="Explore SHOP.CO’s modern edit of casual, formal, party, and active styles."
        path="/"
      />
      <SiteLayout>
          ...
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <dl className="hero-stats hero-step">
                <div>
                  <dt>200+</dt>
                  <dd>International brands</dd>
                </div>
                <div>
                  <dt>2,000+</dt>
                  <dd>Quality products</dd>
                </div>
                <div>
                  <dt>30,000+</dt>
                  <dd>Happy clients</dd>
