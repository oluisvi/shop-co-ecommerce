...
export type StudioProduct = { id: string; name: string; status: string; variants: Array<{ id: string; price: string; inventory: { quantity: number; reservedQuantity: number } | null }> };
