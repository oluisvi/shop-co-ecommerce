...
export const newArrivals: Product[] = [
  { id: "one-life", name: "One Life Graphic T-shirt", image: "/assets/new-arrivals-1.png", price: 220, previousPrice: 260, discount: 15, rating: 4, href: "/products" },
  { id: "skinny-jeans", name: "Skinny Fit Jeans", image: "/assets/new-arrivals-2.png", price: 240, previousPrice: 260, discount: 8, rating: 3.5, href: "/products" },
  { id: "checkered-shirt", name: "Checkered Shirt", image: "/assets/new-arrivals-3.png", price: 180, rating: 4.5, href: "/products" },
  { id: "sleeve-stripe", name: "Sleeve Striped T-shirt", image: "/assets/new-arrivals-4.png", price: 130, previousPrice: 160, discount: 19, rating: 4.5, href: "/products" },
];

export const topSelling: Product[] = [
  { id: "vertical-stripe", name: "Vertical Striped Shirt", image: "/assets/top-selling-1.png", price: 212, previousPrice: 232, discount: 9, rating: 5, href: "/products" },
...
export const recommendations: Product[] = [
  { id: "contrast-polo", name: "Polo with Contrast Trims", image: "/assets/you-might-also-like-1.png", price: 212, previousPrice: 242, discount: 12, rating: 4, href: "/products" },
  ...
  { id: "black-stripe", name: "Black Striped T-shirt", image: "/assets/you-might-also-like-4.png", price: 120, previousPrice: 150, discount: 20, rating: 5, href: "/products" },
];
